...
<body id="page-top">
    ...
    <div class="py-4">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/event">Main</a></li>
            <li class="breadcrumb-item active" aria-current="page">Status</li>
        </ol>
        </nav>
        <span class="badge rounded-pill bg-dark text-white my-2" style="font-size:20px;">Status Event</span>
            ...
            <tr>
                ...
                <tr><th scope="col">Status Event</th></tr>
                
                <form action="{{url('/event/updatestatus/'.$event->id)}}" method="post" id='form1'>
                <td>
                <input type="text" class="form-control" name="status" id="status"  size="500" >
