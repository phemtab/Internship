...
<body id="page-top">
    ...
    <div class="py-4 px-4">
                ...
                @if(session("success"))
                <br><div class="alert alert-success py-2 my-2" role="alert">
                ...
                <!-- breadcrumb -->
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active" style="width:auto;" aria-current="page">Main</li>
                    </ol>
                    </nav>
  ...
  <div class="card" >
    <div class="card-header " id="headingOne">
      <h5 class="mb-0">
      <button class="btn btn-link w-auto" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
         <b>Overview Event </b>
        </button>
      </h5>
    </div>
    ...
    <div id="collapseOne" class="collapsing in" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body ">
            ...
            <span class="badge rounded-pill bg-dark text-white my-2" style="font-size:20px;" id="eventinfo">Event Info</span>
                        ...
                        {{$sortmain->links("pagination::bootstrap-4")}}
                ...
                <tbody>
                    @foreach($sortmain as $row)
                <tr align="center">
                    <td style="display:none" data-title="uuid">{{$row->uuid}}</td>
                    @if($row->status=="END")
                    <td data-title="Status"><button class="badge badge-dark" style="font-size:10px;border: 2px solid #5a5c69"><b>{{$row->status}}</b></button></td>
                    @elseif($row->status=="ACTIVE")
                    <td data-title="Status"><button class="badge badge-success" style="font-size:10px;border: 2px solid #1cc88a"><b>{{$row->status}}</b></button></td>
                    @else
                    <td data-title="Status"><button class="badge badge-danger" style="font-size:10px;border: 2px solid #e74a3b"><b>{{$row->status}}</b></button></td>
                    @endif
...
var myBarChart = new Chart(ctx, {
  type: 'bar',
  data: {
    labels: ["ALL","THISDAY" ,"ACTIVE", "END"],
    datasets: [{
      label: "Revenue",
      backgroundColor: "#4e73df",
      hoverBackgroundColor: "#2e59d9",
      borderColor: "#4e73df",
      data: [{{$count}},{{$countthisday}}, {{$countwait}}, {{$countend}}],
    }],
  },
  options: {
      ...
      yAxes: [{
        ticks: {
          ...
          callback: function(value, index, values) {
            return number_format(value) +" Event";
          }
        },
        gridLines: {
