            ...
            <div class="row">
                ...
                <div class="col lg-8" >
                    ...
                    <table class="table" style="width: 1100px;">
                        ...
                        <tbody>
                        <tr>
                            <td align="center" id="qr"><a href="/event/fillformevent/{{$row->uuid}}"><img src="https://chart.googleapis.com/chart?chs=500x500&cht=qr&chl=https://dev.invp.co.th/intern/event/fillformevent/{{$row->uuid}}" width="200px" height="200px" ></a><</td>
                        </tr>
                        </tbody>
