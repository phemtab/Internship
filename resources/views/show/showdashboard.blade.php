...
<head>
    ...
    <link href="https://dev.invp.co.th/intern/public/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    
    <link
        href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i"
        rel="stylesheet">
    <!-- Custom styles for this template-->
    <link href="https://dev.invp.co.th/intern/public/css/sb-admin-2.min.css" rel="stylesheet">
      ...
      <div class="card-body ">
            <div class="chart-pie pt-4">
             <canvas id="myBarChart"></canvas>
                        ...
                        <td><a href="{{url('/welcome_screen/create')}}" class="btn md-3" style="width:240px;height:35px; color: #fff;background-color:#4e73df;"><b><i class="fa fa-plus-circle" aria-hidden="true"></i> Create Welcome Screen</b></a></td>
                        </div>
                ...
                <tr align="center">
                    ...
                    <td></td>
                    <td><a href="{{url('/welcome_screen/edit/'.$row->screen_id)}}">{{$row->name}}</td>
                    <td>{{$row->datestart}}</td>
                    <td>{{$row->dateend}}</td>
                    <td>{{$row->timestart}}</td>
                    <td>{{$row->timeend}}</td>
                    <td>{{$row->devicename}}</td>
                    <td><a href="{{url('/welcome_screen/edit/'.$row->screen_id)}}"  class="btn" style="color: #4e73df;text-decoration: none;background-color: transparent;"><i class="fas fa-edit"></i></a></td>
                    <td><a href="{{url('/welcome_screen/softtrash/'.$row->screen_id)}}" onclick="return confirm('คุณต้องการย้ายข้อมูล Screen นี้ไปถังขยะหรือไม่ ?')" class="btn" style="color: #4e73df;text-decoration: none;background-color: transparent;"><i class="fas fa-trash"></i></a></td>
                    <td>
                    <form action="{{url('/welcome_screen/link/'.$row->uuid )}}"><a href="{{url('/welcome_screen/link/'.$row->uuid )}}" class="btn" style="color: #4e73df;text-decoration: none;background-color: transparent;"><i class="fa fa-qrcode"></i></a></form></td>
                    <td><form action="{{url('/welcome_screen/link/'.$row->uuid )}}"><a href="{{url('/welcome_screen/callback/'.$row->uuid )}}" class="btn" style="color: #03fcad;text-decoration: none;background-color: transparent;"><i class="fa fa-qrcode"></i></a></form></td>
                </tr>
                @endforeach
