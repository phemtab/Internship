...
<div id="app">
    ...
    <section id='header' ref='header'>
        <div class='wrap'>
            ...
            <div class='ui-tics' v-for='n in ["{{$screen->message_top}}","{{$screen->message_bot}}"]' :class='n' :key='"UITics" + n'>
                <h3 style="position: absolute;top: 12vh;">{{$screen->message_top}}</h3>
                
                <h3 style="position: absolute;top: 85vh;">{{$screen->message_bot}}</h3>
            </div>
            <div class='ui-grid'>
                <div class='ui-box'>
                    ...
                    <div>
                        ...
                        <img class="profile" src="{{asset($people->profile)}}" alt="">
                        <h1 class='title' slot='content'><span>{{$people->firstname}}<em> {{$people->lastname}}</span></em></h1>
                        @else
                        <img class="profile" src="{{asset($visitor->profile)}}" alt="">
                        <h1 class='title' slot='content'><span>{{$visitor->firstname}}<em> {{$visitor->lastname}}</span></em></h1>
                        @endif
