      ...
      <div class="card-body ">
            <div class="chart-pie pt-4">
             <canvas id="myBarChart"></canvas>
                    ...
                    <div class="card" style="width:1090px;" width="100%">
                ...
                <tr align="center">
                    ...
                    <td><a href="{{url('/welcome_screen/softtrash/')}}" onclick="return confirm('คุณต้องการย้ายข้อมูล Event นี้ไปถังขยะหรือไม่ ?')" class="btn btn-danger btn-circle"><i class="fas fa-trash"></i></a></td>
                    <td><a href="{{url('/welcome_screen/link/'.$row->uuid )}}"  class="btn btn-primary btn-circle"><i class="fa fa-qrcode"></i></a></td>
