...
<head>
  ...
  <link rel="stylesheet" href="css/animated-weather-card.css">
...
<style>
	body {
	background-image: url('https://images.wallpaperscraft.com/image/asia_rice_fields_palm_trees_economy_7057_1920x1200.jpg');
...
<img src="image/tony stark.jpeg" width="300" height="300">
</br></br></br>
<h1>Welcome Tony Stark to INVP </h1>
</div>
</div>
</div>
</div>
...
<script src='https://cdnjs.cloudflare.com/ajax/libs/snap.svg/0.4.1/snap.svg-min.js'></script><script  src="js/animated-weather-card.js"></script>
