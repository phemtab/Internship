...
function introAnimation() {
  ...
  const textBoxTitleL = $$('.ui-text.l h3');
  const textBoxTitleR = $$('.ui-text.r h3');
  ...
  .from(['.ui-batts.l .batt', '.ui-batts.r .batt'], duration / 4, {
    width: 0,
    ease: easeOutElastic },
  duration / 4).
  from(['.ui-batts.t .batt', '.ui-batts.b .batt'], duration / 4, {
    height: 0,
    ease: easeOutElastic },
  duration / 4)
...
function spaceWorld(targetElement) {
  ...
  function init() {
    ...
    document.addEventListener('change', onLoad, false);
