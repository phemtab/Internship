...
@keyframes deconstructed4 {
  ...
  100% {
    ...
    <center>
        <div class="container">
            <div>
        <br><br><br><br><br><br><img src="https://th.bing.com/th/id/OIP.qRvPPKbbuRxx1Rv7DblIXwHaHi?pid=ImgDet&rs=1" style="display: inline-block;width:200px;height:200px;">
            </div>
        </div>
          
    <div class='info' style="display: inline;">
    <div class="container-fluid"><br>P'GIB DEV <br>Location : ประชุมห้อง ball room 1 ชั้น 1 <br> Welcome To Office</Location> </div>
    </div>   
