...
<head>
    ...
    <title>Edit Welcome Screen</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Content Wrapper -->
        <div id="content-wrapper" class="d-flex flex-column" style="overflow-x: auto;">
     ...
     <!-- ส่วนที่เป็น Content หลักแต่ละหน้า -->
        ...
        <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/intern/welcome_screen">Welcome Screen</a></li>
        <li class="breadcrumb-item active" aria-current="page">Edit Welcome Screen</li>
        </ol>
        </nav>
        <!-- breadcrumb -->            
            <div class="row">
                    ...
                    <div class="card-body" style="width:1100px;">
                        ...
                        <div id="formcreate">
                        <form action="{{url('/welcome_screen/update/'.$screen->id)}}" method="post" id="showform" enctype="multipart/form-data">
                        @csrf
                               
                        <div id="div1" class="row">
                                <div class="col">
                                    <label for="name" id="name1"><b>Welcome Screen Name</b></label>
                                    <input type="text" class="form-control" name="name" id="name1"  size="250" value="{{$screen->name}}" placeholder="{{$screen->name}}">
                                    @error('name')
                            ...
                            <div id="div2" class="row">
                                <div class="col">
                                    ...
                                    <input type="date" name="datestart" id="datestart" class="form-control" value="{{$screen->datestart}}">
                                </div>
                                <div class="col">
                                    <label for="device"><b>วันที่สิ้นสุด</b></label>
                                    <input type="date" name="dateend" id="dateend" class="form-control" value="{{$screen->dateend}}">
                                </div>
                            </div>
                            <br>
                            <div id="div3" class="row">
                                <div class="col">
                                    ...
                                    <input type="time" name="timestart" id="timestart" class="form-control" value="{{$screen->timestart}}">
                                </div>
                                <div class="col">
                                    <label for="device"><b>เวลาสิ้นสุด</b></label>
                                    <input type="time" name="timeend" id="timeend" class="form-control" value="{{$screen->timeend}}">
                                </div>
                            </div>
                            <br>
                                ...
                                <div class="col">
                                    ...
                                    <tbody>
                                        @foreach($persons as $person => $value)
                                            ...
                                            <td style="width: 250px;"><input type="checkbox" name="{{$value->id}}" id="{{$value->id}}" style="margin-right:10px;" value="{{$value->id}}">{{$value->firstname}}</td>
                            ...
                            <label for="theme"><b>Theme</b></label>
                                <div class="scrollmenu" id="fortheme" style="overflow: auto;white-space: nowrap;">
                                <div class="row" style="display: flex;flex-wrap:nowrap;margin-right: -.75rem;margin-left: -.75rem;width: auto;">
                                        <div class="col" style="text-align: center;">
                                            ...
                                            <input type="checkbox" name="theme" id="theme1" value="space" style="text-align: center;" checked><label class="checkbox-inline" for="preview1" style="text-align: center;" > Space</label><br>
                                            @else
                                        ...
                                        <div class="col" style="text-align: center;">
                                            @if(($screen->theme) == "office")
                                            <input type="checkbox" name="theme" id="theme2" value="office" checked><label class="checkbox-inline" for="preview1" style="text-align: center;" > Office</label><br>
                                            @else
                                        ...
                                        <div class="col" style="text-align: center;">
                                            @if(($screen->theme) == "theme_3")
                                            <input type="checkbox" name="theme" id="theme2" value="theme_3" checked><label class="checkbox-inline" for="preview1" style="text-align: center;" > Theme 3</label><br>
                                            @else
                            ...
                            <div id="div7" class="row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" name="message-top" id="message-top" value="{{$screen->message_top}}">
                                </div>
                                <div class="col">
                                    <label for="message-bot"><b>ข้อความล่าง</b></label>
                                    <input type="text" class="form-control" name="message-bottom" id="message-bottom" value="{{$screen->message_bot}}">
                                </div>
                            </div>
                            <br>
