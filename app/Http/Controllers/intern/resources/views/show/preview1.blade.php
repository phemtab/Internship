        ...
        <div class='wrap'>
            ...
            <div class='ui-grid'>
                <div class='ui-box'>
                    ...
                    <div>
                        <img class="profile" src="https://dev.invp.co.th/intern/public/file/profile/white version.png" style="top:21vh;width: 90px; height: 90px;" alt=""><br>
                        <h1 class='title' slot='content' style="position:relative;top:22vh;font-size:3.2vw;"><span>FIRSTNAME <em>LASTNAME</span></em></h1>
                        <h3 class="toptext" style="top: -37vh;">Top Message</h3>
                        <h3 class="bottext" style="bottom:-28vh;">Bottom Message</h3>
                    </div>
