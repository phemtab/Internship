...
<head>
  ...
  <link rel="stylesheet" href="public/css/animated-weather-card.css">
  <link rel="stylesheet" href="public/css/orb.css">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/meyer-reset/2.0/reset.min.css">
<link rel="stylesheet" href="public/css/modal.css">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/normalize/5.0.0/normalize.min.css">
<link rel="stylesheet" href="public/css/glitch.css">
...
setInterval(() => {
	fetch('isDirty/').then(res => res.text()).then(data => { //dirty
	if(data.dirty){
...
Date.prototype.myMounth = function(){
	if (m == 0){this.myProp = "January"};
	if (m == 1){this.myProp = "February"};
	if (m == 2){this.myProp = "March"};
	if (m == 3){this.myProp = "April"};
	if (m == 4){this.myProp = "May"};
	if (m == 5){this.myProp = "June"};
	if (m == 6){this.myProp = "July"};
	if (m == 7){this.myProp = "August"};
	if (m == 8){this.myProp = "September"};
	if (m == 9){this.myProp = "October"};
	if (m == 10){this.myProp = "November"};
	if (m == 11){this.myProp = "December"};
}
  });
</script>
<body>
...
<div class="container">	
	...
	<nav>
		<ul>
			...
			<li><a id="button-sun" class="active"><i class="wi wi-day-sunny"></i></a></li>
		</ul>
	</nav>
...
<img src="{{asset($first->profile)}}" width="300" height="300">
</br></br></br>
<h1>Welcome {{$first->name}} to INVP </h1>
</div>
</div>
</div>
</div>
...
<!-- partial -->
  ...
  <script src='public/js/orb.js'></script>
<script src='https://cdnjs.cloudflare.com/ajax/libs/gsap/1.19.0/TweenMax.min.js'></script>
<script src='https://cdnjs.cloudflare.com/ajax/libs/snap.svg/0.4.1/snap.svg-min.js'></script><script  src="public/js/animated-weather-card.js"></script>
