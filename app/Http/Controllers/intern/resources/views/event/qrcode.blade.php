...
<body id="page-top">
    ...
    <div class="py-4 px-4">
        ...
        <span class="badge rounded-pill bg-dark text-white my-2" style="font-size:20px;">QR Code Detail</span>
            ...
            <div class="row">
                ...
                <div class="col lg-8" >
                    ...
                    <table class="table" style="width: 1100px;">
                        ...
                        <thead>
                            <tr>
                            @foreach($qrcodeview as $row) 
                                <th>QR Code for {{$row->NameEvent}} event</th>
                            @endforeach
                            </tr>
                        </thead>
                        ...
                        <tbody>
                        <tr>
                            <td align="center" id="qr"><a href="https://dev.invp.co.th/intern/event/fillformevent/{{$row->uuid}}"><img src="https://chart.googleapis.com/chart?chs=500x500&cht=qr&chl=https://dev.invp.co.th/intern/event/fillformevent/{{$row->uuid}}" width="200px" height="200px" ></a><</td>
                        </tr>
                        </tbody>
