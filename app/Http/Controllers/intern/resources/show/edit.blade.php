            ...
            <div class="row">
                    ...
                    <div class="card-body" style="width:1100px;">
                        ...
                        @csrf
                            ...
                            <input type="text" class="form-control" name="name" id="name1"  size="500" value="{{old('name')}}" placeholder="{{$screen->name}}">
                            @error('name')
                            ...
                            <form action="{{url('/welcome_screen/edit/'.$screen->id)}}" method="post" id="showform" enctype="multipart/form-data">
                            ...
                            <br><textarea type="text" rows="3" cols="110" class="mention" name="message" id="message" placeholder='{{$screen->message}}พิมพ์ @ ตามด้วยชื่อคนที่ต้องการ เช่น @tony'></textarea><br><br>
                            </div>
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <input type="time" id="timestart" name="timestart" value="{{$screen->timestart}}">
                                </div>
                                <div>
                                    <label for="timeend">เวลาสิ้นสุด</label>
                                    <input type="time" id="timeend" name="timeend" value="{{$screen->timeend}}"> 
                                </div>
                            </div>
                            ...
                            <br>
                                <div>
                                    ...
                                    <input type="date" id="datestart" name="datestart" value="{{$screen->datestart}}">
                                </div>
                                <div>
                                    <label for="dateend">วันที่สิ้นสุด</label>
                                    <input type="date" id="dateend" name="dateend" value="{{$screen->dateend}}">
                                </div>
                            </div>
